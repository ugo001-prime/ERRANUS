(function () {
  ...
  window.editProfileField = function (field) {
    if (['email', 'phone', 'role'].includes(field)) return note('This setting is locked and cannot be edited.');
