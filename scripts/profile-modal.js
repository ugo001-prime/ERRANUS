(function () {
  ...
  style.textContent = '.readonly-row>div{display:flex;gap:12px;align-items:center;justify-content:space-between}.readonly-row b{font-weight:600}.readonly-row .small{display:block;margin-top:4px}.edit-field{padding:7px 12px;font-size:12px;white-space:nowrap}';
