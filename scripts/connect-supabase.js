...
function messagesInbox(){
  ...
  return '<div class="chat-inbox"><div class="ey">MESSAGES</div><h1 class="title">Your chats</h1><p class="intro">Select a person to open your recorded task conversation.</p>'+(cards?'<div class="chat-list">'+cards+'</div>':'<div class="card">No chats yet. Open an assigned task and select Message to start a conversation.</div>')+(available.length?'<div class="banner"><b>Task messaging</b><p class="small">Chats are visible only to the client and assigned worker.</p></div>':'')+'</div>';
}
